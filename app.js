(() => {
  ...
  // WhatsApp:
  // - Mobile: intenta abrir la app directo con whatsapp://
  // - fallback a wa.me solo si sigue visible la página
    ...
    if (els.tktSave) {
      els.tktSave.onclick = () => {
        ...
        Promise.resolve().then(async () => {
          ...
          if (opened) {
            toast(copied ? "Abrimos WhatsApp. Comprobante copiado ✓" : "Abrimos WhatsApp…");
            return;
          }
          ...
          openAlertModal({
            ...
            msg:
              ...
              "Abrilo manualmente y compartí este comprobante.\n\n" +
              "Tip: sacale una captura de pantalla a este comprobante.",
          });
        });
      };
